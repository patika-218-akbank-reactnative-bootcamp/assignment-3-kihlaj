...
const BottomNavigation = () => {
  return (
    <BottomNav.Navigator
      ...
      <BottomNav.Screen name="Telegram" component={Messages} options={{
      ...
      <BottomNav.Screen name="Contacts" component={Contacts} options={{
        headerStyle: {
          height: 60,
        },
        tabBarShowLabel: false,
      ...
      <BottomNav.Screen name="Settings" component={Settings} options={{
        headerStyle: {
          height: 60,
        },
        tabBarShowLabel: false,
